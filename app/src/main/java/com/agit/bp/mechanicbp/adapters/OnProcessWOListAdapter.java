 ...
 */
public class OnProcessWOListAdapter extends RecyclerView.Adapter<OnProcessWOListAdapter.MyViewHolder> {
    ...
    public OnProcessWOListAdapter(Context mContext, List<ModelWOHeader> mOrderList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.adapter_onprocess_fragment_list, parent, false);
