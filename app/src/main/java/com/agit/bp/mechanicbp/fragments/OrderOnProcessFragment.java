...
import com.agit.bp.mechanicbp.adapters.OnProcessWOListAdapter;
...
public class OrderOnProcessFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private OnProcessWOListAdapter orderAdapter;
...
//    private ImageView empty_order;
    ...
    public static OrderOnProcessFragment orderOnProcessFragment = null;

    public OrderOnProcessFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static OrderOnProcessFragment newInstance() {
        OrderOnProcessFragment fragment = new OrderOnProcessFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_order_onprocess, container, false);
...
//        empty_order = (ImageView) view.findViewById(R.id.empty_order);
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.list_order_onprocess);
        ...
        orderAdapter = new OnProcessWOListAdapter(getContext(), orderList);
